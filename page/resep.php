    ...
    <div class="ctg-slide">
        ...
        <div class="ctg-outer">
            <ul class="ctg-inner" id="ctg-content">
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-0">
                    </a>
                    <label>Amerika</label>
                </li>
                <li>
                ...
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-3">
                    </a>
                    <label>Daging</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-4">
                    </a>
                    <label>Goreng</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-5">
                    </a>
                    <label>Ikan</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-6">
                    </a>
                    <label>Jajanan</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-7">
                    </a>
                    <label>Khas Daerah</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-8">
                    </a>
                    <label>Kudapan</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-9">
                    </a>
                    <label>Kue</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-10">
                    </a>
                    <label>Kukus</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-11">
                    </a>
                    <label>Minuman</label>
                </li>
                <li>
                    <a href="#">
                        <img src="img/kebab.jpg" alt="kategori-12">
                    </a>
